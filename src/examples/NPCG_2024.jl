function npcg(tc, ec, TU, GAT, DU, siglmt, tstp, sigdlmt, sigddlmt, sigcmdprv, sigcmdprv2, BRprev, sigs, BAL, BRL, X0, thetatgt, phitgt, Case_Number, auxdata, testdata)
    if tc <= GAT / TU
        return 0, sigs, BRprev, sigcmdprv, sigcmdprv2, testdata
    else
        inum = 0
        ...
        return bankcmd, sigs, BRprev, sigcmdprv, sigcmdprv2, testdata
    end
end